...
from misc.transforms import RandomCrop,Randomresize,RandomHorizontallyFlip
...
class SHHA(data.Dataset):
    def __init__(self, mode, main_transform=None, img_transform=None, gt_transform=None):
        ...
        self.op_crop = RandomCrop((1024,1024)) # RandomCrop(cfg_data.TRAIN_SIZE)
    ...
    def read_image_and_gt(self, fname):
        ...
        if  self.mode == 'test':
            img_path = cfg_data.SHHA_DATA_PATH + '/test/img/' + fname+'.jpg'
