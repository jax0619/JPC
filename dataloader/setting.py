...
__C_GCC.TRAIN_SIZE = (cfg.train_size[0],cfg.train_size[1]) #if mall (240,240)    # (480,848) #Compress image size to reduce training time
#__C_GCC.GCC_TRAIN_SIZE=(640,640)
__C_GCC.DATA_PATH = '../ProcessedData'
__C_GCC.GCC_scene_dir = './data_split/GCC_scenes'

__C_GCC.sou_batch_size = 12
__C_GCC.target_shot_size = 12  # The number of training samples for each class in a task
...
__C_GCC.real='SHHB'
__C_GCC.real_DATA_PATH = '../ProcessedData/'+__C_GCC.real
__C_GCC.real_scene_dir = './data_split/'+__C_GCC.real+'_scenes'
__C_GCC.real_TRAIN_SIZE = (480,480)
__C_GCC.real_STD_SIZE = (768,1024)
